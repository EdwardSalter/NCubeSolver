...
namespace NCubeSolver.Plugins.Display.OpenGL.Models
{
    ...
    {
        protected const float CubeSpacing = 0.05f;
        private static readonly Cube HighlightCube = new Cube(Colors.Pink);
        protected static readonly Color InsideColour = Colors.DarkGray;
        ...
        public virtual void GenerateGeometry(SharpGL.OpenGL gl)
        {
        ...
        protected void AddAnimator(Cubie cubie)
        {
            m_animators.Add(new CubieAnimator(cubie));
        }

        protected void AddToConfiguration(Cubie cubie, int x, int y, int z)
        {
        ...
        protected void ColourCubeFromConfiguration(Cube cube, int x, int y, int z)
        {
