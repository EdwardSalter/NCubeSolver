...
namespace SharpGL.WPF
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FixedOpenGLControl"/> class.
        /// </summary>
        public FixedOpenGLControl()
        {
            InitializeComponent();
        ...
        {
            //  Get the control.
            FixedOpenGLControl me = o as FixedOpenGLControl;
        ...
        private static readonly DependencyProperty FrameRateProperty =
          DependencyProperty.Register("FrameRate", typeof(double), typeof(FixedOpenGLControl),
        ...
        private static readonly DependencyProperty RenderContextTypeProperty =
          DependencyProperty.Register("RenderContextType", typeof(RenderContextType), typeof(FixedOpenGLControl),
          new PropertyMetadata(SharpGL.RenderContextType.DIBSection, new PropertyChangedCallback(OnRenderContextTypeChanged)));
        ...
        private static readonly DependencyProperty DrawFPSProperty =
          DependencyProperty.Register("DrawFPS", typeof(bool), typeof(FixedOpenGLControl),
